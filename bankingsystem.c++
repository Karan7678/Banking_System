...
class bank
{
 ...
 void bank :: withdraw(void){
    ...
    if(bal>withdraw)
    {
        ...
        lasttransaction = "Failed Withdrawal of: " + to_string(withdraw) + " due to insufficient funds.";
    }
 }
 void bank :: display(void){
    ...
    cout<<setw(50)<<" ZLast Transaction: "<<lasttransaction<<endl;
 }
 ...
 int main(){
    ...
    bank ol;
    int option;                                                                             //to display main screen
    system("cls");
    do{
